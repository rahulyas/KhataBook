...
public class fragment_home_dashboard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        debit_amount_symbol.setImageDrawable(getResources().getDrawable(R.drawable.rs_symbol));

        credit_amount = myDB.credit_transaction_amount(user_id);
        creditbalance.setText("+ "+credit_amount);
        credit_amount_symbol.setImageDrawable(getResources().getDrawable(R.drawable.rs_symbol1));
        ...
        if((credit_amount - debit_amount) >=0 ){
            ...
            net_amount_symbol.setImageDrawable(getResources().getDrawable(R.drawable.rs_symbol1));
        }else{
            netbalance.setText("- "+Math.abs(credit_amount - debit_amount));
            netbalance.setTextColor(getResources().getColor(R.color.warning));
            net_amount_symbol.setImageDrawable(getResources().getDrawable(R.drawable.rs_symbol));
        }
