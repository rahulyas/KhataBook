...
/* This will write the database*/
        SQLiteDatabase db = this.getWritableDatabase();
    }
/* Here We Create Over Table */
    @Override
...
/* Here We Drop Over Table */
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Here we Drop Over Tables
...
/* This will Store the User Updated Passcode */
...
// here we check condition with the help of " if loop "
         if(db != null){
...
/* this is the part of Debit Transaction Amount*/
...
/* Customer List Debit Transaction */
...
/* Store New Existing Friend User Data */
...
/* Here we Check Friend Exist ot Not */
    public Cursor check_friend_exist(String user_id,String friend_phone_number){
...
/* here we get user id */
    public Cursor get_user_id(String user_phone_number){
...
/* Here we Get Transaction Details */
    public Cursor get_transaction_details(String transaction_id){
