...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.MyViewHolder> {
    ...
    public TransactionAdapter(Context context, String user_id, ArrayList transaction_name, ArrayList transaction_phone_number, ArrayList transaction_amount, ArrayList transaction_time, ArrayList transaction_sender_id, ArrayList transaction_image, ArrayList transaction_id) {
    ...
    public TransactionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.dashboardtransaction_row,parent,false);
    ...
    public void onBindViewHolder(@NonNull TransactionAdapter.MyViewHolder holder, int position) {
        ...
        if(String.valueOf((transaction_sender_id.get(position))).compareTo(user_id)==0){
            ...
            holder.transactionamountsymbol.setImageDrawable(context.getResources().getDrawable(R.drawable.rs_symbol));
        }else{
            holder.transaction_amount_text.setText("+ "+String.valueOf(transaction_amount.get(position)));
            holder.transaction_amount_text.setTextColor(context.getResources().getColor(R.color.sucess));
            holder.transactionamountsymbol.setImageDrawable(context.getResources().getDrawable(R.drawable.rs_symbol1));
        }
