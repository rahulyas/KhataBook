...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder>{
    ...
    public ChatAdapter(Context context, String user_id, ArrayList transaction_amount, ArrayList transaction_time, ArrayList transaction_remarks, ArrayList transaction_sender_id, ArrayList transaction_id) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (String.valueOf(transaction_sender_id.get(position)).compareTo(user_id) == 0){
            ...
            holder.share_icon.setImageDrawable(context.getResources().getDrawable(R.drawable.share_icon));
        }else{
            holder.transaction_amount_text.setText("+ "+String.valueOf(transaction_amount.get(position)));
